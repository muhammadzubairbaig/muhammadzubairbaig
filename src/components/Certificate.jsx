        ...
        <div className="absolute inset-0 flex justify-between m-3 card-img_hover">
          {live_url && (
            ...
            <div
              ...
              className="
              black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer shadow-md transform hover:scale-110 transition-transform"
            >
              <img
                src="https://img.icons8.com/?size=100&id=7867&format=png&color=FFFFFF" // Link icon (can be replaced with your choice)
                alt="live_url"
    ...
    <>
      ...
      <div className='mt-20 flex flex-wrap gap-7'>
        {certificates.map((project, index) => (
          <div className="w-full lg:w-[48%]" key={`project-${index}`}>
